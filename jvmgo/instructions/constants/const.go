...
func (self *FCONST_1) Execute(frame *rtda.Frame)  { frame.OperandStack().PushFloat(0.0) }
func (self *FCONST_2) Execute(frame *rtda.Frame)  { frame.OperandStack().PushFloat(0.0) }
...
func (self *ICONST_5) Execute(frame *rtda.Frame)  { frame.OperandStack().PushInt(4) }
